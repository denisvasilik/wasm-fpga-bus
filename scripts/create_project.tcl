...
set files_vhd [list \
 ...
 [file normalize "${project_src}/WasmFpgaBusPackage.vhd" ]\
 [file normalize "${project_src_gen}/vhd_gen/header/wasm_fpga_bus_header.vhd" ]\
 [file normalize "${project_src_gen}/vhd_gen/wishbone/wasm_fpga_bus_wishbone.vhd" ]\
...
set obj [get_filesets sources_1]
set_property -name "top" -value "WasmFpgaBus" -objects $obj
set_property -name "top_auto_set" -value "0" -objects $obj
set_property -name "top_file" -value "${project_src}/WasmFpgaBus.vhd" -objects $obj
...
set obj [get_filesets sim_1]
set_property "top" "tb_WasmFpgaBus" $obj
